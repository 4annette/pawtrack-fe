...
import { 
  ...
  Upload, Camera, Image as ImageIcon, Loader2, LogOut, User, FileText, MapPin, Bell, Search, AlertCircle
} from "lucide-react";
import { toast } from "sonner";
import PawTrackLogo from "@/components/PawTrackLogo";
import { createFoundReport, uploadFoundReportImage, logoutUser, fetchNotifications, markNotificationAsRead } from "@/services/api";
                                    ...
                                    {hours.map(h => {
                                        ...
                                        return (
                                            <button 
                                                ...
                                                className={`w-full p-2 text-center text-xs font-bold cursor-pointer 
        ...
        <div className="container mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={userMenuRef}>
                    <button onClick={() => { setIsNotificationMenuOpen(false); setIsUserMenuOpen(!isUserMenuOpen); }} className="w-9 h-9 rounded-full bg-emerald-100 border border-emerald-200 flex items-center justify-center text-emerald-700 font-bold text-xs active:scale-90 transition-transform outline-none">
