...
import {
    ...
    Navigation, Calendar, BadgeCheck, Info
} from "lucide-react";
                                        ...
                                        {dateValue && (
                                            <div className="flex flex-col items-end gap-1 shrink-0 ml-2">
                                                <span className="text-[10px] font-black text-emerald-600/50 uppercase tracking-tighter flex items-center gap-0.5">
                                                    <Info className="w-2.5 h-2.5" /> {t('date_lost_label') || 'Date Lost'}
                                                </span>
                                                <span className="text-xs font-bold text-emerald-700 bg-white border border-emerald-200 px-2 py-1 rounded-md whitespace-nowrap">
